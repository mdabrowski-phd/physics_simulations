...
plt.xlabel("wsp x")
plt.ylabel("wsp y")
plt.savefig(folder + "rys1.pdf", format="pdf")
plt.show()
plt.clf()

plt.subplot(311)
plt.title("Algorytm Eulera")
plt.plot(ts ,T1, "r-",ts ,V1, "r--")
plt.grid(True)
plt.ylabel("T(t), V(t)") 
plt.legend(("T", "V"))
plt.subplot(312)
plt.title("Algorytm Verleta")
plt.plot(ts ,T2, "g-",ts ,V2, "g--")
plt.grid(True)
plt.ylabel("T(t), V(t)") 
plt.legend(("T", "V", ))
plt.subplot(313)
plt.title("Algorytm Leapfrog")
plt.plot(ts ,T3, "b-",ts ,V3, "b--")
plt.grid(True)
plt.ylabel("T(t), V(t)") 
plt.xlabel("czas t")
plt.legend(("T", "V"))
plt.savefig(folder + "rys2.pdf", format="pdf")
plt.show()
plt.clf()
...
plt.ylabel("E(t)=T(t)+V(t)")
plt.xlabel("czas t")
plt.savefig(folder + "rys3.pdf", format="pdf")
plt.show()
